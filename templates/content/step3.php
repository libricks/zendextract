<h1 id="hello">Etape 3- Configuration des champs</h1>
<h2>Extraction : <?php echo $_["extraction"]->getName() ?> </h2>
<form class="form-horizontal" method="post" action="<?php echo $_["webRoot"] ?>/index.php/apps/zendextract/extraction/step3POST">
    <table class="table table-bordered table-striped table-hover sortable">
        ...
        <?php foreach($_["fields"] as $field): ?>
            <tr>
                ...
                <td>
                    <input name="fields[<?php echo $field->id ?>][column_name]" class="form-control" type="text" value="<?php echo $field->getColumnName() ?>"/>
...
<!--                <td></td>-->
                <td>
                    <div data-option="1">
                        ...
                        <input  name="fields[<?php echo $field->id ?>][date_format]" class="form-control" type="text" value="<?php echo $field->getDateFormat() ?>"/>
                        <a href="http://php.net/manual/fr/function.strftime.php" target="_blank">format</a>
                    </div>
                    <div data-option="2">
                        <label>Nombre de colonnes</label>
                        <input  name="fields[<?php echo $field->id ?>][nb_columns]" type="number" min="0" max="20" value="<?php echo $field->getNbColumns() ?>">
                        <br>
                ...
                <td>
                    ...
                    <button type="button" class="move up btn btn-default"><i class="fa fa-chevron-circle-up" aria-hidden="true"></i></button>
                    <button type="button" class="move down btn btn-default"><i class="fa fa-chevron-circle-down" aria-hidden="true"></i></button>
                </td>
    ...
    <a href="<?php echo $_["webRoot"] ?>/index.php/apps/zendextract/extraction/step/2/<?php echo $_["extraction"]->id ?>" class="btn btn-success">Précédent</a>
